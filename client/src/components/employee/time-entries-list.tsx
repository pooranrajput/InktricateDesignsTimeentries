...
export default function TimeEntriesList({ timeEntries, isLoading, onUpdate }: TimeEntriesListProps) {
  ...
  if (isLoading) {
    return (
      <div>
        <h4 className="text-md font-medium text-foreground mb-4">Recent Entries</h4>
      ...
      <div className="space-y-3 max-h-96 overflow-y-auto">
        {timeEntries.length === 0 ? (
          ...
          timeEntries.map((entry) => (
            <div key={entry.id} className="bg-muted rounded-lg p-4 border border-border">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Button
                    ...
                    className="text-muted-foreground hover:text-muted-foreground h-6 w-6 p-0"
                  >
